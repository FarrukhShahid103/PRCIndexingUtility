 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<div style='float:left;'><select id='tablePagination_rowsPerPage'><option value='5'>5</option></select></div>");
        htmlBuffer.push("<div style='float:left; padding-left:5px;'>per page</div>");
        htmlBuffer.push("</span>");
        htmlBuffer.push("<span id='tablePagination_paginater'>");
        htmlBuffer.push("<div style='float:left;'><img id='tablePagination_firstPage' src='" + defaults.firstArrow + "'></div>");
        htmlBuffer.push("<div style='float:left;'><img id='tablePagination_prevPage' src='" + defaults.prevArrow + "'></div>");
        htmlBuffer.push("<div style='float:left; padding:0px 5px;'>Page</div>");
        htmlBuffer.push("<div style='float:left;'><input id='tablePagination_currPage' type='input' value='" + currPageNumber + "' size='1'></div>");
        htmlBuffer.push("<div style='float:left; padding:1px 5px 0px;'>of<span id='tablePagination_totalPages'>" + totalPages + "</span></div>");
        htmlBuffer.push("<div style='float:left;'><img id='tablePagination_nextPage' src='" + defaults.nextArrow + "'></div>");
        htmlBuffer.push("<div style='float:left;'><img id='tablePagination_lastPage' src='" + defaults.lastArrow + "'></div>");
        htmlBuffer.push("</span>");
        htmlBuffer.push("</div>");
