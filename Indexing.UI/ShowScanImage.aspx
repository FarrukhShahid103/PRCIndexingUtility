<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowScanImage.aspx.cs" Inherits="ShowScanImage" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="grdScanImage" runat="server" AutoGenerateColumns="False" CssClass="MainGridViewStyle"
            ...
            Height="100%" Width="100%" PageSize="1" OnRowDataBound="grdScanImage_RowDataBound">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
