...
<asp:Content ID="content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script type="text/javascript">
        ...
        function ClickHereToPrint() {
            try {
                //    var oIframe = document.getElementById('frmPDFViewer');
                //    var oContent = document.getElementById('IndexingDiv').innerHTML;
                ...
                //        oDoc.close();
                var div = document.getElementById("IndexingDiv");
                div.innerHTML = '<iframe src="Indexing.aspx" onload="this.contentWindow.print();"></iframe>';
        ...
        <div id="IndexingDiv" style="width: 100%; min-height: 350px;">
                ...
                <div style="width: 340px;" id="divLoadImage">
                    <div style="clear: both; width: 100%;">
                        ...
                        <div class="RightValueDivControlPopup">
                            ...
                            <div style="float: right; padding-right: 10px;">
                                <img src="image/calendar-icon.png" alt="" id="scanCal" style="cursor: pointer;" /></div>
                    ...
                    <div style="clear: both; width: 100%;">
                        ...
                        <div class="RightValueDivControlPopup">
                            ...
                            <div style="float: right; padding-right: 10px;">
                                <img src="image/calendar-icon.png" alt="" id="entryCal" style="cursor: pointer;" /></div>
            ...
            <div style="width: 100%; clear: both; display: none; padding-top: 20px;" id="divEntryForm">
                ...
                <div style="width: 77%; min-height: 400px; float: left;">
                    <div style="width: 100%;">
                        <div style="width: 98%; overflow: hidden; padding: 5px;" class="landScape">
